...
def app():
    ...
    st.markdown("3. **Tipe Nyeri Dada (Chest Pain Type):** Tipe nyeri dada yang dialami oleh pasien. Terdapat 4 nilai yang mungkin:")
    ...
    st.markdown("4. **Tekanan Darah Istirahat (Resting Blood Pressure):** Tekanan darah pasien dalam keadaan istirahat (dalam mmHg).")
    st.markdown("5. **Kolesterol Serum (Serum Cholestoral):** Kadar kolesterol serum pasien dalam mg/dl.")
    st.markdown("6. **Gula Darah Puasa (Fasting Blood Sugar):** Kadar gula darah pasien setelah puasa selama 12 jam. Jika nilai > 120 mg/dl, maka nilai adalah 1; jika ≤ 120 mg/dl, maka nilai adalah 0.")
    st.markdown("7. **Hasil Elektrokardiogram Istirahat (Resting Electrocardiographic Results):** Hasil elektrokardiogram (EKG) pada saat istirahat. Terdapat 3 nilai yang mungkin:")
    ...
    st.markdown("8. **Denyut Jantung Maksimum Tercapai (Maximum Heart Rate Achieved):** Denyut jantung maksimum yang dicapai oleh pasien.")
    st.markdown("9. **Angina yang Dipicu Olahraga (Exercise Induced Angina):** Menunjukkan apakah pasien mengalami angina yang dipicu oleh aktivitas fisik. Jika nilai adalah 1, maka pasien mengalami angina yang dipicu oleh olahraga; jika nilai adalah 0, maka tidak mengalami angina yang dipicu oleh olahraga.")
    st.markdown("10. **Depresi ST yang Diinduksi oleh Olahraga Terhadap Istirahat (OldPeek/ST Depression Induced by Exercise Relative to Rest):** Perbedaan depresi segmen ST yang dihasilkan oleh aktivitas fisik dibandingkan dengan keadaan istirahat.")
    st.markdown("11. **Kemiringan Segmen ST Puncak Saat Olahraga (Slope of the Peak Exercise ST Segment):** Kemiringan segmen ST puncak saat melakukan aktivitas fisik. Terdapat 3 nilai yang mungkin:")
    st.markdown("    - 0: Kemiringan tidak dapat ditentukan.")
    st.markdown("    - 1: Kemiringan naik.")
    st.markdown("    - 2: Kemiringan turun.")
    st.markdown("12. **Jumlah Pembuluh Darah Utama (Number of Major Vessels):** Jumlah pembuluh darah utama yang diwarnai dengan flourosopi selama prosedur angiografi. Nilai ini berkisar antara 0 hingga 3, yang mengindikasikan jumlah pembuluh darah utama yang mengalami penyempitan atau kerusakan.")
